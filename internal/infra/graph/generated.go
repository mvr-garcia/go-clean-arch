...
import (
	...
	"github.com/mvr-garcia/go-clean-arch/internal/infra/graph/model"
...
func (ec *executionContext) field_Mutation_createOrder_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalOOrderInput2ᚖgithubᚗcomᚋmvrᚑgarciaᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOOrder2ᚖgithubᚗcomᚋmvrᚑgarciaᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder,
		true,
		false,
	)
}
...
func (ec *executionContext) _Query_listOrders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOOrder2ᚕᚖgithubᚗcomᚋmvrᚑgarciaᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalOOrder2ᚕᚖgithubᚗcomᚋmvrᚑgarciaᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOOrder2ᚖgithubᚗcomᚋmvrᚑgarciaᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOOrder2ᚖgithubᚗcomᚋmvrᚑgarciaᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) unmarshalOOrderInput2ᚖgithubᚗcomᚋmvrᚑgarciaᚋgoᚑcleanᚑarchᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v any) (*model.OrderInput, error) {
	if v == nil {
		return nil, nil
	}
